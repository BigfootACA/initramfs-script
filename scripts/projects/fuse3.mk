...
build/fuse3/build/build.ninja: build/musl-gcc build/fuse3/meson.build build/fuse3/.patched build/sysroot/usr/lib/libudev.so
...
build/fuse3/build/.built: build/musl-gcc build/fuse3/build/build.ninja
	@ninja \
		-C build/fuse3/build \
		$(FUSE3_BUILD_FLAGS)
	@touch $@
