...
root/usr/bin/usb: build/sysroot/usr/bin/usb root/usr/lib/libdrm.so root/usr/lib/libjson-c.so root/usr/lib/liblvgl.so root/usr/lib/liblvgl_font.so root/usr/lib/libc.so
